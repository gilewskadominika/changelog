...
-- CreateIndex
CREATE UNIQUE INDEX "Product_id_belonsToId_key" ON "Product"("id", "belonsToId");

-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_belonsToId_fkey" FOREIGN KEY ("belonsToId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
